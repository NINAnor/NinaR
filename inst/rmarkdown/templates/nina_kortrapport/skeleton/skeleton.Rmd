...
Resultater
========
R-kod kan legges til på vanlig vis. Fargemønstret kan endres gjennom `highlight: xxx` Yaml-avsnittet i starten på dokomentet. PDFen kan låses gjennom å angi `secure_pdf: yes` i Yaml-avsnittet.
