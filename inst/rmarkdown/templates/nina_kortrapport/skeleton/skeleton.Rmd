...
Når R-pakken `NinaR` er installert, finner man mallen i Rstudio gjennom `File -> New File -> R Markdown -> From templates`. Alternativt kan en mall produseres gjennom `rmarkdown::draft("title", template="nina_kortrapport", package="NinaR")`.
