...
\fancypagestyle{titlefooter}{% Define title footer (change to svg logo)
  ...
  \lfoot{\vspace{1cm}\hspace{-1cm}\includegraphics[height=2cm]{logo.eps}}
   \rfoot{\vspace{2.5cm}\hfill\Large\darkGrey{\texttt{Norsk institutt for naturforskning}}}
...
\end{center}
  \lfoot{\color{darkgrey}\vspace{1.5cm}\normalsize\texttt{\textbf{Norsk institutt for naturforskning}}\\
\begingroup
\texttt
...
http://www.nina.no
\endgroup}
   \rfoot{\vspace{4cm}\hfill\Large\darkGrey{\texttt{Samarbeid og kunnskap for framtidas miljøløsninger}}}
    \begin{tikzpicture}[remember picture,overlay]
  \fill[footgrey]
    (current page.south west)
    rectangle
...
%\hspace{-1cm}
\Huge{\darkGrey{\texttt{\textbf{NINA} Kortrapport}}} \hspace{.7cm} \textbf{\orange{$reportnr$}}
\vspace{2cm}
