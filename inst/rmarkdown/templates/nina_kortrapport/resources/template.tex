...
\fancypagestyle{endfooter}{% Define endpage footer (change to svg logo)
  ...
  \chead{\vspace{1cm}ISSN: 2464-2797 \\
...
\AtEndDocument{\fancyhf{}
\null\ifodd\value{page}\else\clearpage\fi
\newgeometry{a4paper, bottom=8cm, top=2cm, left=1.5cm, right=1.5cm}\pagestyle{endfooter}}
%\newgeometry{bottom=8cm, top=2cm, left=1.5cm, right=1.5cm}\pagestyle{endfooter}

%Set up custom colors
\usepackage{xcolor}
\usepackage{blindtext}
\definecolor{darkOrange}{RGB}{219,140,68}
\definecolor{lightOrange}{RGB}{255,192,128}
\definecolor{ashgrey}{RGB}{128, 128, 128}
\definecolor{darkgrey}{RGB}{77, 92, 108}
\definecolor{footgrey}{RGB}{233, 235, 238}
...
\clearpage
\newgeometry{bottom=2cm, top=2cm, left=2.5cm, right=2.5cm}
%Page 4
\fancyhf{}
\pagestyle{fancy}
...
%\clearpage
%\newgeometry{bottom=8cm, top=2cm, left=1.5cm, right=1.5cm}
