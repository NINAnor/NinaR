...
\rfoot{\vspace{2.2cm}\hfill\Large\color{darkgrey}{\narrow{Norsk institutt for naturforskning}}}
\begin{tikzpicture}[remember picture,overlay]
  \fill[footgrey]
...
\footnotesize{$self-ref$}~NINA Rapport $reportnr$. Norsk institutt for naturforskning. \href{http://hdl.handle.net/11250/$handle-endpoint$}{http://hdl.handle.net/11250/$handle-endpoint$} \par \smallspace
...
\footnotesize{$self-ref$} NINA Rapport $reportnr$. Norsk institutt for naturforskning. \href{http://hdl.handle.net/11250/$handle-endpoint$}{http://hdl.handle.net/11250/$handle-endpoint$} \par
\vspace{0.5cm}
\normalsize{
$sammendrag$} \\
...
\footnotesize{$english-self-ref$} NINA Rapport $reportnr$. Norsk institutt for naturforskning. \href{http://hdl.handle.net/11250/$handle-endpoint$}{http://hdl.handle.net/11250/$handle-endpoint$}\par
\vspace{0.5cm}
\normalsize{
$abstract$} \\
