...
\newgeometry{bottom=5.5cm, top=5cm}
...
$endfor$
 \begin{tikzpicture}[remember picture,overlay, anchor=south west]
   \node at ([yshift=4.1cm,xshift=-0.2cm]current page.south west){\includegraphics[width=21.5cm, height=14.0cm]{title_img.png}};
 \end{tikzpicture}
\restoregeometry
\end{titlepage}
