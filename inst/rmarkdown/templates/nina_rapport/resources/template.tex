...
\rfoot{\vspace{2.2cm}\hfill\Large\lightGrey{\narrow{Norsk institutt for naturforskning}}}
\begin{tikzpicture}[remember picture,overlay]
  \fill[footgrey]
...
$endfor$
 \begin{tikzpicture}[remember picture,overlay, anchor=south west]
  \node at ([yshift=4.75cm,xshift=-0.24cm]current page.south west){\includegraphics[width=21.35cm, height=13.9cm]{$cover_picture$}};
 \end{tikzpicture}
\restoregeometry
\end{titlepage}
...
\footnotesize{$self-ref$} NINA Rapport $reportnr$. Norsk institutt for naturforskning. \par
\vspace{0.5cm}
\normalsize{
$sammendrag$} \\
