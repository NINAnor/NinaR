...
\fancypagestyle{titlefooter}{% Define title footer (change to svg logo)
  ...
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \coordinate[below=.49cm of a,xshift=3.4cm]  (rapportnr);
    \fill[footgrey] (a) rectangle (b);
    \node[rotate=90] at (legend) {\color{darkgrey}\Huge{\narrowbold{NINA~}\narrow{Rapport}}};
    \node at (rapportnr) {\color{orange}\Large{\narrowbold{$reportnr$}}};
 \end{tikzpicture}
\lfoot{\vspace{1.1cm}\hspace{-1cm}\includegraphics[height=1.6cm]{logo.eps}}
\rfoot{\vspace{2.2cm}\hfill\Large\color{darkgrey}{\arialnarrow{Norsk institutt for naturforskning}}}
\begin{tikzpicture}[remember picture,overlay]
  \fill[footgrey]
...
\fancypagestyle{endfooter}{% Define endpage footer (change to svg logo)
 ...
 \node (a) at (11.5,4.5) {};
 \node (b) at (15,-2) {};
 \coordinate[above=2.5cm of b,xshift=-2.5cm]  (legend);
...
\newgeometry{bottom=6cm, top=4.6cm, left=3.2cm, right=1.5cm}
...
\setcounter{page}{1}
\fancyfoot[C]{
\newgeometry{bottom=2.6cm, top=3cm, right=2cm}
...
\normalsize
\newgeometry{bottom=3cm, top=3cm, left=2.5cm, right=5cm}
\small{$self-ref$}~NINA Rapport $reportnr$. Norsk institutt for naturforskning. \href{http://hdl.handle.net/11250/$handle-endpoint$}{http://hdl.handle.net/11250/$handle-endpoint$} \par \smallspace
...
\small{$self-ref$} NINA Rapport $reportnr$. Norsk institutt for naturforskning. \href{http://hdl.handle.net/11250/$handle-endpoint$}{http://hdl.handle.net/11250/$handle-endpoint$} \par
\vspace{0.5cm}
\normalsize{
$sammendrag$} \\
...
\small{$english-self-ref$} NINA Rapport $reportnr$. Norsk institutt for naturforskning. \href{http://hdl.handle.net/11250/$handle-endpoint$}{http://hdl.handle.net/11250/$handle-endpoint$}\par
\vspace{0.5cm}
\normalsize{
$abstract$} \\
