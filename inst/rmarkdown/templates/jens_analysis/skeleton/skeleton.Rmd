...
#You could also use the .pgpass file as shown in https://www.postgresql.org/docs/current/libpq-pgpass.html. Then you don't have to provide your credentials at all. gisdata-db.nina.no doesn't synk it's credentials to the Windows password servers yet though, so this only works (for me) with other databases. 
