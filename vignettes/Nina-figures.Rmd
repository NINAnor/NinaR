...
g <- ggplot2::ggplot(mpg, aes(cty, hwy))  +
  ggplot2::geom_point(aes(colour = cyl)) +
   scale_color_nina(discrete = F) +
  add_logo(xmin = 25,
           xmax = 30,
           stroke_scale = 0.3)
